    ...
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: 'rgba(0,0,0,0.53)'}}>
      <div style={{ width: '800px',borderRadius: "8px",background: "#fff", display: 'flex'}}>
        <WrapperLeftContainer>
          ...
          <WrapperInputForm.Password placeholder="password" style={{marginBottom: '15px'}} value={password} onChange={(e) => setPassword(e.target.value)}/>
          <WrapperInputForm.Password placeholder="confirm password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
          ...
          <p style={{fontSize: '14px'}}>you have an acount ? <WrapperTextLight onClick={() => {navigate('/sign-in')}}>Sign-in?</WrapperTextLight> </p>
        </WrapperLeftContainer>
