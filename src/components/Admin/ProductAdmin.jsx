...
const ProductAdmin = () => {
  ...
  const mutation = useMutationHooks(async (data) => {
    ...
    const res = await ProductService.createProduct(stateProduct, access_token);
    return res;
  });
    ...
    <div>
      ...
      {selectionKeys?.length > 0 && (
        <>
          ...
          <Modal
            title="Delete Many Product"
            open={isModalDeleteManyOpen}
            onOk={handleDeleteManyOk}
            onCancel={() => setIsModalDeleteManyOpen(false)}>
